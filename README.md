...
- [Herdr backend](docs/herdr-backend.md) (the sole supported runtime backend)
- [tmux backend](docs/tmux-backend.md) (retained legacy adapter, not selectable)
- [Zellij backend](docs/zellij-backend.md) (retained legacy adapter, not selectable)
- [Orca backend](docs/orca-backend.md) (retained legacy adapter, not selectable)
- [cmux backend](docs/cmux-backend.md) (retained legacy adapter, not selectable)
