...
Local no-mistakes Test is intent-targeted and must not re-run every `tests/*.test.sh`; [`.github/workflows/ci.yml`](.github/workflows/ci.yml) owns hosted check selection and documents the behavior-job exclusion.
