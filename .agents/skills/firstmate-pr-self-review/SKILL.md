...
The surface section must contain `Authority:`, `Security:`, `Path:`, `Failure:`, `Tests:`, `Documentation:`, and `Delivery:` fields in the form `reviewed; surface=<surface>; files=<...>; evidence=<path>:<line> sha256=<line-digest> change-sha256=<change-digest> line-hex=<changed-line-bytes> before-hex=<old-line-bytes|none> after-hex=<new-line-bytes|none> hunk=<path>:<line> behavior-sha256=<behavior-proof>; consequence=anchor=<path>:<line> side=<old|new> sha256=<line-digest> change-sha256=<change-digest> line-hex=<changed-line-bytes> before-hex=<old-line-bytes|none> after-hex=<new-line-bytes|none> hunk=<path>:<line> behavior-sha256=<behavior-proof> binding=<surface-binding>; fix=anchor=<path>:<line> side=<old|new> sha256=<line-digest> change-sha256=<change-digest> line-hex=<changed-line-bytes> before-hex=<old-line-bytes|none> after-hex=<new-line-bytes|none> hunk=<path>:<line> behavior-sha256=<behavior-proof> binding=<surface-binding>`, with each evidence, consequence, and fix reference naming the same listed tracked file and actual changed hunk, each line digest and byte encoding being independently derived from its declared added or deleted line, and the before/after encodings being the exact lossless changed-line transition for that hunk (`none` for the absent side). The behavior proof is the exact lowercase SHA-256 of the surface, all three anchor references and sides, both before/after line encodings, the changed-hunk digest, and the required surface behavior/action. The binding must cover the behavior proof and all three exact anchors, so a surface claim cannot be detached from the verified transition it describes.
