...
write_exempt_brief() {
  local home=$1 id=$2 reason="configuration: task=$id; target=tests/fm-spawn-worktree-settle.test.sh worktree settling fixture; action=exercise settling without product change"
