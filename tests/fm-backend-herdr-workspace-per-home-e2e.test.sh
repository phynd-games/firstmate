...
write_exempt_brief() {
  local home=$1 id=$2 reason="configuration: task=$id; target=tests/fm-backend-herdr-workspace-per-home-e2e.test.sh Herdr workspace fixture; action=exercise isolated spawn placement"
