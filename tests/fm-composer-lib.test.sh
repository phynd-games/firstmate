...
test_matrix_herdr_halfblock_rule_bounds_bare_wrap() {
  ...
  local screen plain out halfblock_up halfblock_down edge_up edge_down arrow dot
  halfblock_up='▄▄▄▄▄▄▄▄'
  halfblock_down='▀▀▀▀▀▀▀▀'
  edge_up='▄▄▄'
  edge_down='▀▀▀'
 ...
 $halfblock_down
  ...
  screen="transcript
 $halfblock_up
  ${ESC_LOCAL}[2m$arrow ${ESC_LOCAL}[0;7mA${ESC_LOCAL}[0;2mdd a follow-up${ESC_LOCAL}[0m
 $halfblock_down
  Cursor Grok 4.5 High $dot 6.7%   Run Everything
  ~/wt $dot 64cdd3a"
