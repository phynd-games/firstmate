...
write_exempt_brief() {
  local home=$1 id=$2 reason="configuration: task=$id; target=tests/fm-busy-adapter-wiring.test.sh busy adapter fixture; action=exercise wiring without product change"
