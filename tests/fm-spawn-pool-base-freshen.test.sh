...
write_exempt_brief() {
  local home=$1 id=$2 body=${3:-"brief for $id"} reason="configuration: target=tests/fm-spawn-pool-base-freshen.test.sh pooled spawn fixture; action=exercise spawn behavior without product change"
